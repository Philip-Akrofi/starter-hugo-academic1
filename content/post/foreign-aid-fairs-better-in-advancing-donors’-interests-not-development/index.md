---
title: Foreign Aid Fairs Better in Advancing Donors’ Interests, not Development
subtitle: ""
date: 2025-03-17T06:47:40.386Z
summary: "*The potential humanitarian crises that could result from President
  Trump’s temporary halt of significant USAID disbursements is yet another
  testament that current models of aid hardly promote growth and development but
  fester dependency, writes Philip Akrofi Atitianti.*"
draft: false
featured: false
image:
  filename: featured
...
President Trump’s decision to halt significant USAID disbursements has drawn mixed reactions, with aid advocates’ mass outcry about how humanitarian needs that USAID sustained will survive without funding. Accounting for about [29%](https://www.oecd.org/en/topics/official-development-assistance-oda.html) of OECD countries’ funding in 2023, USAID is a significant funder of global aid.  [Reports](https://www.npr.org/sections/goats-and-soda/2025/02/13/nx-s1-5295011/what-is-happening-with-pepfar-it-depends-whom-you-ask) have already started pouring in about how health and emergency reliefs are in limbo due to the halt. Despite the misery that USAID’s freeze is causing, it is yet another stark reminder that the current model of aid management by donor countries is not the way to go.

The current aid model of “giving fish” instead of “equipping to fish” basically succeeds in providing relief in a manner that inadvertently fuels a dependency syndrome in a bid to address problems that need rigorous approaches to increase the likelihood of a long-term solution. Despite the multitude of arguments and findings that aid more likely fuels a dependency syndrome amidst other problems, donor countries haven’t significantly altered their approaches. It seems the “[Dead Aid](https://www.penguin.co.uk/books/56126/dead-aid-by-moyo-dambisa/9780141031187)” advice by Dambisa Moyo hasn’t been heeded.

One of the most persistent inadvertent effects of such funding by USAID and other agencies is its potential to erode local ownership and undermine the development of self-reliant systems. By providing parallel systems of service delivery, these programs can inadvertently weaken existing governmental structures and hinder the development of indigenous expertise needed for development. In Ghana and Uganda, for instance, local government services were crowded out, and villagers left worse off after the arrival of some [NGOs](https://insight.kellogg.northwestern.edu/article/international-aid-development-ngos-crowding-out-government); the help had become harmful.

When donors give out items such as free grains purchased from farmers in the donor countries to the deprived in recipient countries, local farmers in recipient countries lose market and may eventually give up on their production. While US [farmers](https://www.npr.org/2025/02/27/nx-s1-5311663/farmers-will-be-hit-hard-by-the-dismantling-of-usaid) are concerned about the sustainability of their farms should USAID be permanently ceased, much hasn’t been heard of farmers in recipient countries who have been put out of jobs because of these free grains.
